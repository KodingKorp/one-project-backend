...
use crate::capabilities::{
    background::{
        orchestrator::{CreateJob, CreateQueue, CreateSchedule},
        JobHandler,
    },
...
use super::{
    controllers,
    job_handlers::{
        abandoned_cart_cron_handler, register_side_effect_handler::RegisterSideEffectHandler,
    },
};
...
impl Service for IAMService {
    fn register_routes() -> Option<impl OpenApi> {
        Some((
            controllers::authentication::Api,
            controllers::organisations::PublicApi,
        ))
    }

    fn register_private_routes() -> Option<impl OpenApi> {
        Some((controllers::users::Api, controllers::organisations::Api))
    }
    ...
    async fn register_background(
        ...
        orchestrator
            ...
            .await;
        orchestrator
            .register_schedule(CreateSchedule {
